...
//   createdAt: Date;
//   updatedAt: Date;
//   pinned: boolean; // TO-FIX user table -> auxiliar table -> | user_id | report_id |
//   createdBy: number;
//   validatedBy: null;
//   resolvedBy: null;
//   category: string;
...
//         const departmentReports = await fetchReportsByDepartment(
...
//             }}
//           >
//             <Text style={{ color: selectedCategory == null ? "#000" : "#fff" }}>
//               All
//             </Text>
//           </TouchableOpacity>
...
//                 borderRadius: 999,
//                 backgroundColor:
//                   selectedCategory === category ? "#fff" : "#1f1f1f",
//                 borderWidth: 1,
//                 borderColor: "#3a3a3a",
//               }}
//             >
...
//         ListEmptyComponent={
//           <Text
//             style={{ color: "#9aa0a6", textAlign: "center", marginTop: 24 }}
//           >
